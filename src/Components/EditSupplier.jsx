...
function EditSupplier() {
  ...
  const getSupplierData = async () => {
    try {
      ...
      setSupplier(selectedSupplier.data);
      formik.setValues(selectedSupplier.data);
    } catch (error) {
    ...
    <div className='container  mt-5'>
      <div className='row text-center'>
        <div className='col-lg-12'>
          <h1 className='text-center crud-heading'>Edit and Update Supplier Details </h1>
          <p className='text-muted'>fill the form to edit supplier informations</p>
      ...
      <div className='row align-items-center justify-content-center'>
        <div className='col-lg-8  '>
          ...
          <form onSubmit={formik.handleSubmit}  >
            ...
            <div className='row mt-2'>
              <div className='col-md-8'>
                <label className='label' >supplierAddress : </label>
            ...
            <div className='d-inline-flex gap-1 mb-5'>
              <button className='btn btn-updateSupplier mb-5 mt-4 p-2' type="submit" > Update Supplier Info </button>
            </div>
          </form>
        </div>
      </div>
